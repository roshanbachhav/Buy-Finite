...
<body>
    ...
    <div class="mt-16">
        <div class="p-4 sm:ml-64 mt-15">
            <form method="post" action="{{ route('postAddUserShipping') }}"
                ...
                <div class="bg-gradient-to-r from-purple-600 to-indigo-400 p-6">
                    <h2 class="text-2xl font-semibold text-white">Add New Shipping Address</h2>
                    <p class="text-sm text-blue-100">Fill the proper fields for delivered products</p>
                </div>
                ...
                <div class="p-6 space-y-8">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 items-center">
                        ...
                        <div class="sm:col-span-2">
                            <input type="text" name="name" value="{{ old('name') }}"
                                ...
                                placeholder="Enter your proper name : Sam Tim Joe">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 items-center">
                        ...
                        <div class="sm:col-span-2">
                            <input type="email" name="email" value="{{ old('email') }}"
                                ...
                                placeholder="Email : sample123@gmail.com">
                            @error('email')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 items-center">
                        ...
                        <div class="sm:col-span-2">
                            <input type="tel" name="phone_number" value="{{ old('phone_number') }}"
                                class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('phone_number') border-red-500 @enderror"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 items-start">
                        ...
                        <div class="sm:col-span-2">
                            <textarea name="house"
                                class="w-full px-4 py-2 border rounded-lg h-32 focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('house') border-red-500 @enderror"
                                placeholder="Enter House Number with Landmark">
                            {{ old('house') }}
                        </textarea>
                            @error('house')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
