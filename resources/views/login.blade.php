...
<body>
    ...
    <div class="h-screen text-gray-900 flex justify-center shadow-2xl overflow-hidden mt-5">
        <div
                        ...
                        <form action="{{ route('postLoginForm') }}" method="POST">
                            ...
                            <div class="mx-auto max-w-xs">
                                ...
                                <div class="flex justify-between">
                                    <div class="mt-3 text-sm text-black hover:underline block text-left">

                                        <a href="{{ route('signup') }}" class="text-blue-500">Signup for new
                                            account</a>
                                    </div>
                                    <a href="{{ route('recovery.password') }}"
                                        class="mt-3 text-sm text-blue-500 hover:underline block text-right">
                                        Recovery Account
                                    </a>
                                </div>
                            </div>
