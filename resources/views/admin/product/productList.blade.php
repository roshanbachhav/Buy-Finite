                ...
                <div class="flex flex-col justify-between gap-8 mb-4 md:flex-row md:items-center">
                    <div>
                        ...
                        <p class="block mt-1 font-sans text-base antialiased font-normal leading-relaxed text-gray-700">
                            This is current top 5 Products out of {{ $tp }}
                        </p>
                    </div>
                    <div class="flex w-full gap-2 shrink-0 md:w-max">
                        ...
                        <a href="{{ route('getProduct') }}" class="inline-block p-0 m-0 leading-none">
                            <button
                        ...
                        @if ($products->isNotEmpty())
                            @foreach ($products as $p)
                                <tr>
                                    ...
                                    <td class="p-4 border-b border-blue-gray-50">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="flex flex-col">
                                                ...
                                                <p
                                                    class="block font-sans text-xs antialiased font-medium leading-normal text-blue-gray-900">
                                                <p>{{ \Illuminate\Support\Str::words($p->description, 5, '...') }}</p>
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <td class="p-4 border-b border-blue-gray-50">
                                        <p
                                            class="block font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900 line-through">
                                            {{ '₹' . $p->listPrice }}
                                        </p>
                                    </td>
                                    <td class="p-4 border-b border-blue-gray-50">
                                    ...
                                    <td class="p-4 border-b border-blue-gray-50">
                                        ...
                                        {{ $p->featured === 1 ? 'bg-green-500/20 text-green-900' : 'bg-amber-500/20 text-amber-900' }}">
                                                <span>{{ $p->featured === 1 ? 'YES' : 'NO' }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4 border-b border-blue-gray-50">
                                    ...
                                    <td class="p-4 border-b border-blue-gray-50">
                                        <div class="px-2 py-4 flex items-center space-x-1 justify-start">
                                            <a href="{{ route('getProductEdit', $p->id) }}"
                                            ...
                                            <form method="POST"
                                                action="{{ route('deleteProduct', ['deleteProductId' => $p->id]) }}">
                                                @method('DELETE')
                                                @csrf
                                                <button type="submit"
                        ...
                        @else
                            <tr>
                                <td class="p-4 text-red-700 border-b border-blue-gray-50">
                                    <p>Opps! No Products add from the admin</p>
                                </td>
                            </tr>
                        @endif
                    </tbody>
