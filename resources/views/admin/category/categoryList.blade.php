...
<body>
    ...
    <div
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    <li class="inline-flex items-center">
                        <a href=""
                            class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-yellow-100 dark:text-gray-400 dark:hover:text-white">
                    ...
                    <li class="inline-flex items-center">
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('categoryList') }}"
                                class="ms-1 text-sm font-medium text-gray-700 hover:text-yellow-100 md:ms-2 dark:text-gray-400 dark:hover:text-white">
                                Category</a>
                        </div>
                    </li>
        ...
        <!-- component -->
        <div
            class="relative flex flex-col w-full h-full text-gray-700 bg-white shadow-md rounded-xl bg-clip-border bg-opacity-30 backdrop-blur-lg border-2">
            <div class="relative mx-4 mt-4 overflow-hidden text-gray-700 rounded-none bg-clip-border">
                <div class="flex flex-col justify-between gap-8 mb-4 p-4 md:flex-row md:items-center">
                    <div>
                        <h5
                        ...
                        <p class="block mt-1 font-sans text-base antialiased font-normal leading-relaxed text-gray-700">
                            This is current top 5 categories
                        </p>
                    </div>
                    <div class="flex w-full gap-2 shrink-0 md:w-max">
                        <div class="w-full md:w-72">
                            <div class="relative h-10 w-full min-w-[200px]">
                                ...
                                <input id="inputText"
                                    class="peer h-full w-full rounded-[7px] border border-blue-gray-200 border-gray-500 bg-transparent bg-opacity-20 backdrop-blur-lg  px-3 py-2.5 !pr-9 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-900 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                                    placeholder=" " />
                                <label
                        ...
                        <a href="{{ route('getCategory') }}" class="inline-block p-0 m-0 leading-none">
                            <button
                                ...
                                <tr>
                                    ...
                                    <td class="p-4 border-b border-blue-gray-50">
                                        <div class="flex items-center gap-3">
                                            <img src="{{ asset('images/category_img/' . $c->image) }}"
                                                alt="category-images"
                                    ...
                                    <td class="p-4 border-b border-blue-gray-50">
                                        ...
                                        {{ $c->status === 1 ? 'bg-green-500/20 text-green-900' : 'bg-amber-500/20 text-amber-900' }}">
                                    ...
                                    <td class="p-4 border-b border-blue-gray-50 w-52">
                                        <div class="flex items-center gap-3 w-52">
                                            <p>{{ \Illuminate\Support\Str::words($c->description, 5, '...') }}</p>
                                        </div>
                                    </td>
                                    <td class="p-4 border-b border-blue-gray-50">
                                        <div class="px-2 py-4 flex items-center space-x-1 justify-start">
                                            <a href="{{ route('getEdit', $c->id) }}"
            ...
            <div class="flex items-center justify-between p-4 border-t border-blue-gray-50">
                <a href="{{ $category->previousPageUrl() }}">
                    <button
                        ...
                        type="button" {{ $category->onFirstPage() ? 'disabled' : '' }} wire:click="previousPage">
                        Previous
                    </button>
                </a>
                ...
                <a href="{{ $category->nextPageUrl() }}">
                    <button
                        class="select-none rounded-lg border border-gray-900 py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase text-gray-900 transition-all hover:opacity-75 focus:ring focus:ring-gray-300 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                        type="button" {{ $category->hasMorePages() ? '' : 'disabled' }} wire:click="nextPage">
                        Next
                    </button>
                </a>
            </div>
